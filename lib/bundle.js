...
(function (global, factory) {
    ...
    function bucket () {
        ...
        var bucket = function bucket(data) {
            return d3Array.range(0, Math.ceil(data.length / bucketSize)).map(function (i) {
...
},{"d3-array":2,"d3fc-rebind":4}],2:[function(require,module,exports){
...
},{"../build/d3fc-sample":1,"d3":3,"topojson":5}]},{},[6]);
